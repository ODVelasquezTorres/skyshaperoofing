        ...
        <>
            ...
            <div className="sticky-menu-wrapper" ref={menuRef}>
                ...
                <div className="sticky-menu-bar">
                    ...
                    {/* Left Group */}
                    <a href="https://wa.me/17045848280" target="_blank" rel="noopener noreferrer" className="sticky-menu-item whatsapp-btn" title="WhatsApp">
                    ...
                    <a href="tel:7045848280" className="sticky-menu-item" title="Call Us">
                        <Phone size={22} />
                        <span>Call</span>
                    </a>
